 ...
 * @since 1.0
 */
function percon_get_standard_fonts() {
	return apply_filters(
		'perconstandard_fonts_array',
		array(
 ...
 * @since 1.0
 */
function percon_enqueue_google_font( $font ) {
	...
	$subsets     = '';
	$get_subsets = percon_get_options( array( 'font_subsets', array( 'latin' ) ) );
	...
	// Weights
	$weights = apply_filters( 'percon_font_weights', array( '300', '400', '500', '700', '800' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'percon-google-font-' . $handle, $url, array(), false );
}

function percon_enqueue_google_font_url( $font ) {
	// Get list of all Google Fonts
	$google_fonts = percon_get_google_fonts_array();
