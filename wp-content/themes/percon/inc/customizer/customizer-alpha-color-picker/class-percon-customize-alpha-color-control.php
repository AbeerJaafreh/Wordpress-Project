 ...
 *
 * @package Percon WordPress theme
 * @subpackage  Controls
...
/**
 * Class Percon_Customize_Alpha_Color_Control
 */
class Percon_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			'percon-alpha-color-picker',
			get_theme_file_uri( '/inc/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js' ),
		...
		wp_enqueue_style(
			'percon-alpha-color-picker',
			get_theme_file_uri( '/inc/customizer/customizer-alpha-color-picker/css/alpha-color-picker.css' ),
