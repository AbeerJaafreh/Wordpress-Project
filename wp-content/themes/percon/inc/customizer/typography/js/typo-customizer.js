 ...
 * @since 1.0
 */
function perconGetCss( arraySizes, settings, to ) {
    'use strict';
     var data, desktopVal,
 ...
 */
function perconSetCss( settings, to ){
    'use strict';
    var result     = '';
 ...
 */
wp.customize(
    'percon_options[body_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
                ...
                perconGetCss( arraySizes, settings, to );
            }
        );
    }
);
wp.customize(
    'percon_options[site_title_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[menu_font_size]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
                ...
                var arraySizes = {
                    size: { selectors: '.navigation .stellarnav li a', values: [0] }
                };
...
wp.customize(
    'percon_options[post_blockquote_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[post_title_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
                ...
                var arraySizes = {
                    size: { selectors: '.post-entry .post-details .post-title', values: [0] }
                };
                perconGetCss( arraySizes, settings, to );
            }
        );
...
wp.customize(
    'percon_options[heading_one_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[heading_two_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[heading_three_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[heading_four_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[heading_five_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[heading_six_content]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
                var settings = {
...
wp.customize(
    'percon_options[body_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'percon_options[heading_font_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'percon_options[site_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
...
wp.customize(
    'percon_options[description_title_color]', function (value) {
        'use strict';
        value.bind(
            function( to ) {
