 ...
 * @access public
 */
class Percon_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Percon_Customizer_Range_Value_Control constructor.
	 *
 ...
 * @since 1.0
 */
function percon_sanitize_range_value( $input ) {
	if ( perconis_json( $input ) ) {
		$range_value            = json_decode( $input, true );
		$range_value['desktop'] = '' !== $range_value['desktop'] || '0' === $range_value['desktop'] ? floatval( $range_value['desktop'] ) : '';
